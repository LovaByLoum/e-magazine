(function($) {
    $(document).ready(function() {
        ...
        function e_magazine_add_file(event, selector) {
            ...
            frame.on('select', function() {
                ...
                selector.find('.remove-image, .remove-file').on('click', function() {
                    e_magazine_remove_file($(this).parents('.section'));
                });
            });
        ...
        function e_magazine_remove_file(selector) {
            ...
            selector.find('.upload-button').live('click', function() {
                e_magazine_add_file(event, $(this).parents('.section'));
            });
        }
