...
//enlever le p auto et br auto
add_filter('tiny_mce_before_init','e_magazine_tiny_mce_before_init',10,2);
function e_magazine_tiny_mce_before_init($mceInit, $editor_id){
...
add_filter( 'mce_buttons_2', 'e_magazine_mce_buttons_2' );
function e_magazine_mce_buttons_2( $buttons ) {
...
//add_action( 'wp_enqueue_scripts', 'e_magazine_default_scripts' );
function e_magazine_default_scripts(){
...
//add_filter( 'the_content','e_magazine_default_the_content',9);
function e_magazine_default_the_content($html){
